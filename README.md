...
### With Wget
```
sh -c "$(wget https://raw.githubusercontent.com/mataberat/vim-config/master/install.sh -O -)"
```

### With Curl
```
sh -c "$(curl -fsSL https://raw.githubusercontent.com/mataberat/vim-config/master/install.sh)"
```
